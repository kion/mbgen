...
```sh
go install github.com/kion/mbgen/v2/cmd/mbgen@latest
```
...
* [optional] `feedPostViewOnWebsiteLinkText` - controls the "view on website" link text appended to each post content in generated feeds
  - if not specified, the default value of `View on website ⮵` is used
